...
import { CalendarClockIcon, LogOutIcon, SettingsIcon, ShieldCheckIcon, SmartphoneIcon, UsersIcon } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/backups", label: "Backups", icon: ShieldCheckIcon, exact: false },
